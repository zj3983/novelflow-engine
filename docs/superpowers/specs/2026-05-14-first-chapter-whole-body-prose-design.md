...
整体文风应接近白描：句子清楚，动作具体，对话自然，不靠华丽词语、夸张比喻或谜语式暗示制造气氛。读者应该一眼知道角色在做什么、怕什么、想试什么、下一步要去哪里。

对话要像人物在当下情境里自然说话。NPC、玩家和主角都应有自己的岗位、目的和信息边界，但不能用台词替作者讲规则、讲设定或讲审稿结论。
...
- 每个主要节奏块都要有可见反馈和小代价。
- 不用华丽形容词堆叠、夸张比喻、谜语式短句或故意绕弯的悬疑腔。悬念要落在具体物件、任务门槛、面板变化或人物选择上。
- 不让对话承担说明书功能。人物说话要短、顺、接地气，能推进价格、任务、信任、误会或行动。
...
- 加入白描和自然对话要求：少修辞、少比喻、不猜谜、不用台词讲规则。
...
- 整章提示词和写作包都包含白描、自然对话、少华丽词语、少夸张比喻、不要谜语式表达的要求。
