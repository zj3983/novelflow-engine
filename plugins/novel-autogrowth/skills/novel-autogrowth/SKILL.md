...
手写或重写正文时，按下面的内在工序执行，而不是一次性吐出“漂亮成稿”：

1. 先写粗稿：只保证动作、账目、对话、阻力和事实连续性成立。
2. 再读者电表：逐句检查哪里顺滑但无聊、哪里像解释报告、哪里没有现场压力。
3. 做省略测试：作者知道的后台因果不要全说；让读者从动作、物件、价牌、延迟、拒绝和人物误判里拼出来。
4. 删浮肿：删掉不推进行动、不制造压力、不改变判断的句子，尤其是“这意味着、很明显、他意识到、局势变得”。
5. 测声音：默读对话和短段，确认它像角色说话，不像提示词说明。
6. 保留偏执：本书默认偏执点是算账、成本、NPC 信息边界、现实压力和隐藏优势的可见痕迹；每场至少落到一个具体物件或动作。

这套工序来自真人作者经验的可执行抽象：先允许糟糕初稿，再多轮修清；逐句读自己的反应；用省略保留冰山；二稿压缩浮肿；通过声音和节奏判断句子是否活着。
