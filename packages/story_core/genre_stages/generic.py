...
from packages.story_core.genre_stages.base import (
    GenreStageProfile,
    review_placeholder_actor_names,
)
...
def review_generic_director_plan(*, context) -> list[str]:
    return review_placeholder_actor_names(context.moves)
...
GENERIC_STAGES = GenreStageProfile(
    ...
    review_director_plan=review_generic_director_plan,
