    ...
    "director_generic": PromptTemplate(
        ...
        content="\n".join(
            [
                ...
                "event_plan包含ordered_actions（建议 [{name, action}]）、chapter_satisfaction、chapter_end_hook、world_reactions、stakes、next_focus；chapter_satisfaction包含core_event、obstacle、visible_payoff、cost、outsider_misread、state_change、next_hook。",
