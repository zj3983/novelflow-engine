    ...
    "director": PromptTemplate(
        ...
        content="\n".join(
            [
                ...
                "event_plan: {chapter_title, scene_chain, ordered_actions, numeric_plan, chapter_satisfaction, chapter_end_hook, world_reactions, stakes, next_focus}。",
                "numeric_plan只记录本章实际涉及的可计算项：经验逐次累计与升级时点、怪物生命/伤害/击杀来源、交易总额/手续费/净到账；没有相关数值时返回空对象。",
                ...
                "网游连续性：现实姓名、游戏ID、身份、等级、经验、货币、背包、装备耐久和任务进度以当前连续性账本为准；本阶段只规划变化，不修改账本。",
