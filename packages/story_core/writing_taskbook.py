...
def _first_chapter_scenes(plan: dict[str, Any]) -> list[WritingTaskScene]:
    ...
    return [
        WritingTaskScene(
            ...
            required_surface="27.60元或可用余额、催缴压力、旧头盔或登录入口、《天启之门》开服、全沉浸/开服倒计时/玩家涌入/登录公告至少一个可见背景入口、游戏ID夜烬、职业选择、Lv.1短面板必须含职业/等级/经验/生命/法力/0铜/新手法杖/基础火球术、章首一个具体情绪动作如手指停顿/喉咙发紧/苦笑半秒；不要展开力量/敏捷/体质/智力等扩展属性",
        ...
        WritingTaskScene(
            ...
            title="低级怪小验证",
            goal="只打一小轮低级怪，让苏叶亲眼看到千倍爆率会把普通流程压短，让他比别人更快凑齐任务或装备门槛。",
            required_surface="第一次低级怪战斗、基础火球术或明确的近身应急、击杀后才露出掉落异常、底层协议校验通过、千倍爆率或掉落判定×1000、混沌之种未解析、血蓝/法力/耐久消耗、经验或任务材料进度变化、旁人正常低掉落形成对比、没有铜币收益、战斗中一次疼痛/后怕/侥幸的身体反应",
        ...
        WritingTaskScene(
            ...
            exit_state="本章确认千倍爆率能带来领先；材料未换钱、委托未提交、货币仍是0铜，下一章从任务进度、装备修理、技能或新路线门槛继续。",
            handoff="下一章承接这个具体麻烦，不把第一章改成已经赚钱。",
            target_chars=third,
